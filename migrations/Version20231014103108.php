 ...
 */
final class Version20231014103108 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD CONSTRAINT FK_D8F0A91E727ACA70 FOREIGN KEY (parent_id) REFERENCES `group` (id)');
